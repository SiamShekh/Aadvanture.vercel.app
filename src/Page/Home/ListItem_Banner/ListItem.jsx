...
const ListItem = () => {
    return (
        <Marquee pauseOnHover speed={200} className="flex justify-around items-center gap-10"  gradientColor="#000000" gradientWidth={2050}>
            <div className="flex gap-3 justify-center items-center mr-32">
                <p className="font-Abhaya-Libre text-[#DBFFD5] text-4xl">Exploring</p>
                <GoArrowRight className="w-10 h-10 text-[#DBFFD5]" />
            ...
            <div className="flex gap-3 justify-center items-center mr-32">
                ...
                <FiArrowUpRight className="w-10 h-10 text-[#B6FF89]" />
            </div>
